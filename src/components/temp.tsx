...
//     gsap.set(marqueeContainerRef.current, { opacity: 0 });
...
//             <p className="text-white uppercase tracking-wider text-xs transition-transform duration-500 group-hover:-translate-x-full">
//               Code by
//             </p>
//             {/* "Suraj" shifts left by 65px */}
//             <p className="text-white font-bold text-lg pl-2 transition-transform duration-500 group-hover:-translate-x-[65px]">
//               Suraj
//             </p>
//             {/* "Arya" is positioned absolutely, shifts left by 65px on hover */}
//             <p className="text-white font-bold text-lg absolute left-[120px]  transition-transform duration-500 group-hover:-translate-x-[65px]">
//               Arya
//             </p>
//           </div>
//         </div>
